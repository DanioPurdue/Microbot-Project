...
class FrameProcessor {
  ...
  public:
	...
	virtual void setRobotWidth(int width) = 0;
	virtual void setTargetInformation(Point targetLoc, Point targetDirec) = 0;
...
class VideoProcessor {
  ...
  public:
	  ...
	  cv::Point targetLocation;
	  cv::Point targetDirection;
	  ...
	  void menu() {
		  system("cls");
		  cout << "Menu:" << endl;
		  cout << "1. Start tracking" << endl;
		  cout << "2. Set robot body reference" << endl;
		  cout << "3. Set robot probe reference" << endl;
		  cout << "4. Set body only reference" << endl;
		  cout << "5. Robot Width" << endl;
		  cout << "6. Target Information" << endl;
		  cout << "7. Exit\n" << endl;
	  }
	  ...
	  void run() {
		  ...
		  // output frame
		  cv::Mat output;
		  GUI gui(windowNameOutput, &output);
		  ...
		  else if (error != PGRERROR_OK)
		  {
			  ...
			  cout << "Camera Started" << std::endl;
		  }
		  Image rawImage;
		  bool measureWidth = false;
		  bool getTargetInfo = false;
		  while (!isStopped()) {
			  switch (cv::waitKey(1)) {
			  case 49: //Start tracking
			  ...
			  case 50: //Set robot body reference
				  measureWidth = false;
				  getTargetInfo = false;
				  cout << "Set robot body reference" << endl;
				  callIt = false;
				  pause = true;
				  imgName.clear();
				  gui.point.clear();
			  ...
			  case 51: //Set robot probe reference
				  measureWidth = false;
				  getTargetInfo = false;
				  cout << "Set robot probe reference" << endl;
				  callIt = false;
				  pause = true;
				  imgName.clear();
				  gui.point.clear();
			  ...
			  case 52: //Set the body only
				  measureWidth = false;
				  getTargetInfo = false;
				  cout << "Set robot only reference" << endl;
				  callIt = false;
				  pause = true;
				  imgName.clear();
				  gui.point.clear();
			  ...
			  case 53: //Measure the body length
				  measureWidth = true;
				  getTargetInfo = false;
				  cout << "Set robot body length" << endl;
				  callIt = false;
				  pause = true;
				  gui.point.clear();
				  break;

			  case 54: //select the target and the direction
				  cout << "Set push point and direction" << endl;
				  getTargetInfo = true;
				  measureWidth = false;
				  callIt = false;
				  pause = true;
			  ...
			  if (callIt) {
				  ...
				  frame.copyTo(output);
				  if (measureWidth == true)
				  {
					  gui.robotWidth(&robotWidthInPixel);
					  //cout << robotWidthInPixel << endl;
					  frameProcessor->setRobotWidth(robotWidthInPixel);
				  }
				  else if (getTargetInfo == true)
				  {
					  gui.targetInformation(&targetLocation, &targetDirection);
					  frameProcessor->setTargetInformation(targetLocation, targetDirection);
				  }
				  else if (!imgName.empty()) {
					  if (gui.update(imgName)) {
						  cout << "Done.\n" << endl;
						  imgName.clear();
						  menu();
					  }
